...
var skill_name := "特意防守"        # 技能名

# 实现脚本
var impl_class = "res://define/dataskill/Normal/defense/cs/DuckSkill0_2_2.cs"
...
# ---- 图标 ----
var icon_path := "res://IMG/skill/Normal/defense/0_2_2.png"    # 技能图标图片地址
...
var damage_reduction_rate = 50      # 减伤率（默认0，0-100范围，50代表50%减伤）
...
var gain_power_bingo := [
	{"power_type": 1, "layer": 1, "value": 1, "is_ratio": false, "active_mode": 5},
]
# 应对成功后的 Power：1=RoundPriority先手值；layer=1层；value=1每层+1先手 → 成功抵挡攻击后，自身下一次出手先手值+1
...
# ---- 描述 ----
var main_description := ["特意防守，成功抵挡攻击后下次出手先手值+1"]                    # 主描述（数组类型）
var auxiliary_description := ["防御技能，本回合应对攻击减伤50%，成功抵挡攻击后，自身下一次出手先手值+1"]        # 辅助描述（数组类型）