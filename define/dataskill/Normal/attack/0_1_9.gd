...
var skill_code := 9                 # 技能编号
var skill_name := "气势一击"        # 技能名

# 实现脚本
var impl_class = "res://define/dataskill/Normal/attack/cs/DuckSkill0_1_9.cs"
...
# ---- 图标 ----
var icon_path := "res://IMG/skill/Normal/attack/0_1_9.png"    # 技能图标图片地址
...
# ---- 描述 ----
var main_description := ["裹挟雄浑战意重拳出击"]                    # 主描述（数组类型）
var auxiliary_description := ["威力100的普通攻击，上回合应对成功时，本次威力额外增加80点"]        # 辅助描述（数组类型）