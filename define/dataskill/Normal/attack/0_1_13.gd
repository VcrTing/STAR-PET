...
var skill_code := 13                # 技能编号
var skill_name := "喊叫"            # 技能名

# 实现脚本
var impl_class = "res://define/dataskill/Normal/attack/cs/DuckSkill0_1_13.cs"
...
# ---- 图标 ----
var icon_path := "res://IMG/skill/Normal/attack/0_1_13.png"    # 技能图标图片地址
...
# ---- 描述 ----
var main_description := ["释放高频声波冲击对手"]                    # 主描述（数组类型）
var auxiliary_description := ["基础魔法攻击技能，命中后自身恢复1点能量"]        # 辅助描述（数组类型）