...
var skill_code := 14                # 技能编号
var skill_name := "阻断"            # 技能名

# 实现脚本
var impl_class = "res://define/dataskill/Normal/attack/cs/DuckSkill0_1_14.cs"

# ---- 攻击数值 ----
var attack_value := 70              # 攻击数值/威力
var attack_type := 3                # 攻击类型（对应EnumPetBaseStats：2=物攻[ATK], 3=魔攻[MATK], 0=固伤）
...
# ---- 图标 ----
var icon_path := "res://IMG/skill/Normal/attack/0_1_14.png"    # 技能图标图片地址
...
# ---- 应对与减伤 ----
var bingo_skill_type = 3            # 1 = 应对攻击，3 = 应对状态（阻断：对方释放状态技能时触发打断），0 = 无应对
...
# ---- 描述 ----
var main_description := ["迸发能量冲击波直击敌方"]                    # 主描述（数组类型）
var auxiliary_description := ["魔法攻击技能，可强行打断对手本回合正在释放的状态技能"]        # 辅助描述（数组类型）
