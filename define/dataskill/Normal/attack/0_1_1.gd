...
var skill_name := "拍击"            # 技能名

# 实现脚本
var impl_class = "res://define/dataskill/Normal/attack/cs/DuckSkill0_1_1.cs"
...
# ---- 描述 ----
var main_description := ["用前肢拍打对手进行攻击"]                    # 主描述（数组类型）
var auxiliary_description := ["基础攻击技能，无特殊效果"]        # 辅助描述（数组类型）