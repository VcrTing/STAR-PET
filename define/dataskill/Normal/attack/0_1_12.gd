...
var skill_code := 12                # 技能编号
var skill_name := "吞噬"            # 技能名

# 实现脚本
var impl_class = "res://define/dataskill/Normal/attack/cs/DuckSkill0_1_12.cs"
...
# ---- 能耗 ----
var pp_cost := 6                    # PP能耗（默认2，范围0-50）

# ---- 图标 ----
var icon_path := "res://IMG/skill/Normal/attack/0_1_12.png"    # 技能图标图片地址
...
# ---- 增减益 ----
var gain_energy := 6                # 获得能量（默认0，正数=获得，负数=扣除）
...
# ---- 描述 ----
var main_description := ["张开巨口吞噬敌方精灵"]                    # 主描述（数组类型）
var auxiliary_description := ["威力150的普通攻击，若本次攻击成功击杀目标，自身额外获得6点能耗"]        # 辅助描述（数组类型）