...
var skill_code := 6                 # 技能编号
var skill_name := "冲撞"            # 技能名

# 实现脚本
var impl_class = "res://define/dataskill/Normal/attack/cs/DuckSkill0_1_6.cs"

# ---- 攻击数值 ----
var attack_value := 60              # 攻击数值/威力
...
# ---- 图标 ----
var icon_path := "res://IMG/skill/Normal/attack/0_1_6.png"    # 技能图标图片地址
...
# ---- 描述 ----
var main_description := ["全速向前猛撞敌人"]                    # 主描述（数组类型）
var auxiliary_description := ["威力60的普通攻击，20%概率降低敌方10%物防"]        # 辅助描述（数组类型）