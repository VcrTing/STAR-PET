...
var skill_code := 11                # 技能编号
var skill_name := "大师之力"        # 技能名

# 实现脚本
var impl_class = "res://define/dataskill/Normal/attack/cs/DuckSkill0_1_11.cs"

# ---- 攻击数值 ----
var attack_value := 90              # 攻击数值/威力
...
# ---- 能耗 ----
var pp_cost := 4                    # PP能耗（默认2，范围0-50）

# ---- 图标 ----
var icon_path := "res://IMG/skill/Normal/attack/0_1_11.png"    # 技能图标图片地址
...
# ---- 描述 ----
var main_description := ["久经战斗沉淀的强力一击"]                    # 主描述（数组类型）
var auxiliary_description := ["威力90的普通攻击，每成功抵挡敌方一次进攻，本技能威力永久提升40点"]        # 辅助描述（数组类型）