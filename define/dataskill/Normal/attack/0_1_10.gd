...
var skill_code := 10                # 技能编号
var skill_name := "垂死反击"        # 技能名

# 实现脚本
var impl_class = "res://define/dataskill/Normal/attack/cs/DuckSkill0_1_10.cs"
...
# ---- 图标 ----
var icon_path := "res://IMG/skill/Normal/attack/0_1_10.png"    # 技能图标图片地址
...
# ---- 描述 ----
var main_description := ["血量濒危时迸发反击力量"]                    # 主描述（数组类型）
var auxiliary_description := ["威力80的普通攻击，自身当前血量每降低10%，技能威力永久提升8点"]        # 辅助描述（数组类型）