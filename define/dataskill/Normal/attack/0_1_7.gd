...
var skill_code := 7                 # 技能编号
var skill_name := "乘胜追击"        # 技能名

# 实现脚本
var impl_class = "res://define/dataskill/Normal/attack/cs/DuckSkill0_1_7.cs"
...
var is_hit_combo := true            # 是否连击技能（默认false）

# ---- 能耗 ----
var pp_cost := 1                    # PP能耗（默认2，范围0-50）

# ---- 图标 ----
var icon_path := "res://IMG/skill/Normal/attack/0_1_7.png"    # 技能图标图片地址
...
# ---- 描述 ----
var main_description := ["趁势持续进攻，每一次释放本技能，自身连击层数叠加1层"]                    # 主描述（数组类型）
var auxiliary_description := ["威力40的普通连击攻击，每次释放后自身连击层数+1"]        # 辅助描述（数组类型）