...
var skill_name := "聚能"            # 技能名

# 实现脚本
var impl_class = "res://define/dataskill/Normal/status/cs/DuckSkill0_3_1.cs"
...
# ---- 图标 ----
var icon_path := "res://IMG/skill/Normal/status/0_3_1.png"    # 技能图标图片地址
