...
var skill_name := "极度冰点"        # 技能名

# 实现脚本
var impl_class = "res://define/dataskill/Ice/attack/cs/DuckSkill6_1_1.cs"

# ---- 攻击数值 ----
var attack_value := 0               # 攻击数值/威力
var attack_type := 0                # 攻击类型（对应EnumPetBaseStats：2=物攻[ATK], 3=魔攻[MATK], 0=固伤）
...
# ---- 图标 ----
var icon_path := "res://IMG/skill/Ice/attack/6_1_1.png"    # 技能图标图片地址
...
# ---- 特殊效果 ----
var instant_kill_rate := 70.00       # 秒杀敌人概率（默认0.00）
var instant_kill_damage := 99999    # 秒杀伤害值（默认0，0=不造成秒杀伤害，>0=触发秒杀时造成该数值的固伤）
...
# ---- 描述 ----
var main_description := ["释放足以冻结万物的绝对零度寒气"]                    # 主描述（数组类型）
var auxiliary_description := ["无基础伤害，仅有3%概率直接冰封对手神魂，瞬间完成秒杀"]        # 辅助描述（数组类型）