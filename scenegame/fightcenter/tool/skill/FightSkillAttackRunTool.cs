...
public static class FightSkillAttackRunTool
{
    ...
    /// <summary>
    /// 执行秒杀/即死效果判定（基于 InstantKillRate + InstantKillDamage）
    /// </summary>
    ...
    public static bool ExecuteInstantKill(int index, InsFightSkill sideSkill, string skillName, string effectName)
    {
